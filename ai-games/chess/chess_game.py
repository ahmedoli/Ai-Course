...
# Define colors for board squares and highlights
...
# Simple material-based evaluation scores for pieces
piece_values = {
    chess.PAWN: 1,
    chess.KNIGHT: 3,
    chess.BISHOP: 3,
...
# Draws the entire board and pieces on the screen
...
# Basic evaluation function based on material and game state
...
# Let AI play a move using Minimax
def ai_move(board):
    _, move = minimax(board, 2, -math.inf, math.inf, False)
    if move:
        board.push(move)

# Handles pawn promotion (default: queen, but other options checked)
...
# Displays game result (win/draw) at the end of the game
